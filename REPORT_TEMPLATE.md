...
| Проб-пойнт         | Описание                                                   | Обоснование                                                     |
| ------------------ | ---------------------------------------------------------- | --------------------------------------------------------------- |
| \_\_x64_sys_execve | Системный вызов для выполнения программы                   | Позволяет отслеживать, когда процессы запускают новые программы |
| \_\_x64_sys_openat | Системный вызов для открытия файлов по относительному пути | Позволяет отслеживать доступ к файлам                           |
